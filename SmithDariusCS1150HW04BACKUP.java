...
public class SmithDariusCS1150HW04BACKUP {
	 ...
	 */
		...
		public static void main(String[] args) {
			...
			System.out.println(Starlines + bL + "Welcome to UCCS Bike Share" + bL + (Math.round(bikeNum))
+ " bikes are avaliable" + bL + Starlines);
	...
	+ " bikes are avaliable" + bL + Starlines);
				...
				/*
						...
						while (bikeNum - userBikeQuantity >= 0) {
							if((userBikeQuantity == 1) || (userBikeQuantity == 2) || (userBikeQuantity == 3) || (userBikeQuantity == 4)) 
						{
